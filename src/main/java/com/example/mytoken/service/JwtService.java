...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        extraClaims.put("role", user.isAdmin() ? "ROLE_ADMIN" : "ROLE_USER");
        extraClaims.put("authorities", List.of(user.isAdmin() ? "ROLE_ADMIN" : "ROLE_USER"));
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        return (userIdFromToken.equals(String.valueOf(userDetails.getUsername()))) && !isTokenExpired(token);
    }
